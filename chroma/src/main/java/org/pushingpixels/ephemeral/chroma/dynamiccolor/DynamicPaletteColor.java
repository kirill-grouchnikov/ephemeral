 ...
 * provided by a function that takes a DynamicPalette and returns a value. This ensures ultimate
...
public final class DynamicPaletteColor {
  ...
  private final HashMap<DynamicPalette, Hct> hctCache = new HashMap<>();
   ...
   * @param tone Function that provides a tone, given a DynamicPalette.
  ...
  public DynamicPaletteColor(
      ...
      Function<DynamicPalette, DynamicPaletteColor> secondBackground,
      ContrastCurve contrastCurve,
      Function<DynamicPalette, Double> opacity) {
    this.name = name;
    this.tone = tone;
    this.isBackground = isBackground;
    this.background = background;
   ...
   * @param tone Function that provides a tone, given a DynamicPalette.
   */
  public static DynamicPaletteColor fromPalette(
      String name,
      Function<DynamicPalette, Double> tone) {
   ...
   */
  public static DynamicPaletteColor fromArgb(String name, int argb) {
    Hct hct = Hct.fromInt(argb);
    return DynamicPaletteColor.fromPalette(name, (s) -> hct.getTone());
  }
