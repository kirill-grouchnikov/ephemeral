## Ephemeral theming - color tokens

**Color tokens** are design decisions on how to paint a certain piece of user interface.

Let's look at two Ephemeral skins, Dust Coffee and Magellan:
...
Ephemeral provides the **Chroma** color system that builds on the core foundations of the [Material color utilities](https://github.com/material-foundation/material-color-utilities).
...
<img alt="Tonal palettes, hues"  src="https://raw.githubusercontent.com/kirill-grouchnikov/ephemeral/breeze/docs/images/theming/tonal/tonal-walkthrough-hues.png" width="696" height="646" />
...
<img alt="Tonal palettes, chroma"  src="https://raw.githubusercontent.com/kirill-grouchnikov/ephemeral/breeze/docs/images/theming/tonal/tonal-walkthrough-chroma.png" width="716" height="726" />

This is an example of how increasing values of chroma make for a more colorful tonal palette.

### Ephemeral container color tokens

The next layer in the Chroma color system is **container color tokens**. Ephemeral has three types of containers:
* **active**
* **muted**
* **neutral**
...
<img alt="Container color tokens"  src="https://raw.githubusercontent.com/kirill-grouchnikov/ephemeral/breeze/docs/images/theming/tonal/tonal-walkthrough-containers.png" width="802" height="533" />
...
<img alt="Components"  src="https://raw.githubusercontent.com/kirill-grouchnikov/ephemeral/breeze/docs/images/theming/tonal/tonal-walkthrough-components.png" width="276" height="122" />

**Ephemeral treats every element as a container, and Ephemeral draws every element with container color tokens.**
